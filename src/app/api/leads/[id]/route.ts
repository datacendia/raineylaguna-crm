...
export async function PATCH(
  ...
  try {
    ...
    const allowed = ['name', 'email', 'phone', 'website_url', 'instagram_url', 'instagram_active', 'website_status', 'pipeline_stage', 'notes', 'evaluation', 'strategic_action', 'next_action', 'snoozed_until']
    const fields: string[] = []
    const values: any[] = []
    let idx = 1
